...
# Calculating Details
print(
    "DecisionTreeClassifier Train Score is : ",
    DecisionTreeClassifier.score(X_train, y_train),
)
print(
    "DecisionTreeClassifier Test Score is : ",
    DecisionTreeClassifier.score(X_test, y_test),
)
print("DecisionTreeClassifier Classes are : ", DecisionTreeClassifier.classes_)
print("----------------------------------------------------")

# Calculating Prediction
y_pred = DecisionTreeClassifier.predict(X_test)
y_pred_prob = DecisionTreeClassifier.predict_proba(X_test)
print("Predicted Value for DecisionTreeClassifier is : ", y_pred[:10])
print(
    "Prediction Probabilities Value for DecisionTreeClassifier is : ", y_pred_prob[:10]
)
